  ...
  <div class="modal-dialog modal-dialog-centered modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-evenly border-top-0">
        <button class="btn btn-outline-secondary" data-bs-target="#editModal" data-bs-toggle="modal" @click="backToEditing">返回編輯</button>
        <button class="btn btn-danger" data-bs-dismiss="modal" @click="confirmDeleting">確定刪除</button>
      </div>
    </div>
  </div>
</div>
